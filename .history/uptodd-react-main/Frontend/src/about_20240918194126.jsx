...
const About = () => {
  return (
    <section>
      <h1>About Page</h1>
      <p className="Focus-section">We focus to personalise every child's journey &nbsp at our best. We are obsessed for success at every family which merges with UpTodd</p>
