...
const AboutSection = () => {
  return (
    <section className="About-section">
      <h1>
        We focus on personalizing every child's journey at our best.
      ...
      <div className="our-story">
        ...
        <p>
          From humble beginnings to a leading name in child-focused products, our mission has always been to support parents in nurturing their children's growth and success.
        </p>
      </div>
