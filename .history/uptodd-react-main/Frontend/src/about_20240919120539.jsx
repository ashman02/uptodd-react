  ...
  return (
    <article>
      ...
      <section id="ourstorysection">
        <h1>Our Story</h1>
      <h2>Our goal is to help every parent feel confident. Our play products are designed by child development experts and distilled to their simplest, purest purpose: to be exactly what children need at each stage.</h2>
      </section>
